...
ok(/vch-net-depth/.test(concepts) && /vch-net-rim/.test(concepts) && /vch-hand/.test(concepts) && /vch-wristband/.test(concepts), 'voucher capture includes a deep side-view net, hand and collector wristband');
