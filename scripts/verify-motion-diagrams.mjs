...
ok(/The father always contributes a Z\. Only the chromosomes involved are drawn\./.test(concepts) && /El padre siempre aporta un Z\. Solo se dibujan los cromosomas implicados\./.test(concepts), 'the meiosis panel declares the father\'s Z and that only the relevant chromosomes are drawn');
